...
const AboutPage = () => {
  return (
    <PageWrapper cssClasses="my-10">
      <h2 className="text-36px font-inter font-bold mb-10">About</h2>
      <div className="space-y-10">
        <main>
          <h3 className="text-20px font-inter font-bold mb-5">History</h3>
          <div className="space-y-4">
            ...
            <p>
              In November 2023, both publications were brought together under
              one banner following their purchase by{" "}
              <span className="italic">Glasshouse Country & Maleny News</span>,
              uniting Somerset and Moreton Bay coverage into a single
              publication —<span className="italic">The Sentinel.</span>
            </p>
            <p>
              ...
              coverage extends from Lowood and Fernvale in the south to
              Redcliffe and Bribie Island in the east, Moore and Linville in the
              west, and Elimbah and Beerburrum in the north.
            </p>
            <p>
