  ...
  return (
    <div>
      <div
        ...
        className="text-14px grid gap-5 [&_ul]:list-disc [&_ul]:list-inside [&_ol]:list-disc [&_ol]:list-inside [&_a]:text-blue [&_a]:underline [&_a]:hover:text-blue/80 [&_h2]:text-24px [&_h2]:font-bold [&_h2]:mb-2 [&_h3]:text-20px [&_h3]:font-bold [&_h3]:mb-2 [&_h4]:text-18px [&_h4]:font-bold [&_h4]:mb-2 [h5_]:text-16px [&_h5]:font-bold [&_h5]:mb-2 &_figure]:my-5 [&_figcaption]:text-12px [&_strong]:font-bold [&_em]:italic [&_u]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-teal [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:my-5 &_pre]:bg-beige [&_pre]:p-4 [&_pre]:rounded [&_pre]:overflow-x-auto [&_pre]:my-5 [&_table]:w-full [&_table]:border-collapse [&_table]:my-5 [&_th]:border [&_th]:border-black [&_th]:p-2 [&_th]:bg-beige
  [&_th]:font-bold [&_td]:border [&_td]:border-black [&_td]:p-2 [&_hr]:border-t [&_hr]:border-black [&_hr]:my-5 [&_img]:w-full
