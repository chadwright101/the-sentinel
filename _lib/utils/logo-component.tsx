  ...
  return (
    <div className="relative">
      ...
      <div className="grid place-items-center">
        <h1 className="font-abril-fatface text-white text-[38px] min-[350px]:text-[50px] desktop:text-[114px]">
          Sentinel
        </h1>
        <h2 className="hidden desktop:block text-16px font-normal font-newsreader text-white text-center -mt-10">
